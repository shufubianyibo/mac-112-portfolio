...
# One of them produce numeric "10", and the other gives a categorical "Oct" with sequance.
month(today)
...
# It is the 40th week of the year.
week(today)
```

```{r}
# What do these lines produce / what's their difference?
# "mday" produce the day of month and, and "yday" produce the day of year.
mday(today)
...
```{r}
# What do these lines produce / what's their difference?
# The first one is numeric, and the second one is a categorical with sequence
wday(today)
...
# Our day is behind "2024-02-14", not before it.
